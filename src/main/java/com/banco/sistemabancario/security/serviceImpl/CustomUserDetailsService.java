...
public class CustomUserDetailsService implements UserDetailsService {
        ...
        public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
                ...
                List<SimpleGrantedAuthority> authorityList = new ArrayList<>(); // CREAR LISTA DE PERMISOS, YA QUE
                                                                                // SPRING MANEJA
                                                                                // PERMISOS CON GRANTEDAUTHORITY Y ESTA
                                                                                // ES UNA
                                                                                // DE SUS IMPLEMENTACIONES
                usuario.getRoles()
                                .forEach(rol -> authorityList.add(
                                                new SimpleGrantedAuthority("ROLE_".concat(rol.getRoleEnum().name())))); // TOMAMOS
                                                                                                                        // LOS
                                                                                                                        // ROLES
                                                                                                                        // Y
                                                                                                                        // LOS
                ...
                usuario.getRoles().stream()
                                ...
                                .forEach(permiso -> authorityList.add(new SimpleGrantedAuthority(permiso.getName()))); // AGREGAR
                                                                                                                       // CADA
                                                                                                                       // PERMISO
                                                                                                                       // A
                                                                                                                       // CADA
